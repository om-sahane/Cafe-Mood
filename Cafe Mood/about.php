...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" id="turbowash" href="#">Cafe Mood</a>
  </button>
...
<section class="my-5">
<div class="container">
  <h2 class="text-center">Say Something About Cafe Mood</h2>
...
<footer>
    <p class="p-3 bg-dark text-white text-center">@CafeMood</p>
</footer>
